import { IPageContent, IPaperMetadata, PaperSourceType } from '@rpidanny/google-scholar'

export function getMockPaperMetadata(overrides?: Partial<IPaperMetadata>): IPaperMetadata {
  return {
...
export function getMockPageContent(overrides?: Partial<IPageContent>): IPageContent {
  return {
    papers: [getMockPaperMetadata(), getMockPaperMetadata(), getMockPaperMetadata()],
    totalPapers: 594_000,
